...
arcpy.env.workspace = r"C:\TFM\Modelados Maxent\Q.ilex\maps_reescalados"

# Obtener la lista de rasters en el directorio
raster_list = arcpy.ListRasters()

# Ruta de salida para los nuevos rasters
output_folder = r"C:\TFM\Modelados Maxent\Q.ilex\Inputs_Guidos\2values"
...
for raster_name in raster_list:
    ...
    output_raster = Con(raster > 0.8, 2)
